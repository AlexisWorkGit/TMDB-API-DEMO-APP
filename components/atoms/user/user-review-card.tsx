...
import { UserAvatar } from "@/components/atoms/user";
import { MediaRating } from "@/components/molecules/media";
    ...
    <div className="grid grid-cols-[auto,1fr] items-center gap-2 md:items-start md:gap-x-4">
      ...
      <div className="flex items-center justify-between">
        <h3 className="flex flex-wrap items-center gap-2">
          ...
          <span className="block text-xs text-muted-foreground md:text-sm">@{username}</span>
        </h3>
