...
import { ProviderTable } from "@/components/molecules/provider";
      ...
      <div>
        <h2 className="flex items-center gap-2 text-lg font-medium">
          ...
          <InfoTooltip className="w-60">
            Currently showing providers for <span className="underline">{country}</span> You can
            change your preferred region in the settings
          </InfoTooltip>
        </h2>
        <p className="text-muted-foreground">
          Stream, buy or rent this {type === "tv" ? "tv show" : "movie"} from the providers below.
        </p>
      </div>
