...
import { Episode } from "@/lib/tmdb/models";
import { format } from "@/lib/tmdb/utils";
import { formatValue, pad } from "@/lib/utils";
import { Badge } from "@/components/ui/badge";
import { MediaBackdrop, MediaRating } from "@/components/molecules/media";
    ...
    <div className="flex flex-col rounded-md border">
      ...
      <div className="flex flex-1 flex-col p-4">
        ...
        <div className="mt-auto flex items-center gap-2">
          <MediaRating average={vote_average} count={vote_count} className="leading-none" />
