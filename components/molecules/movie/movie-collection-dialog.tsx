...
import { MediaBackdrop, MediaMiniDetail, MediaPoster } from "@/components/molecules/media";
...
export const MovieCollectionDialog: React.FC<MovieCollectionDialogProps> = ({
  ...
  return (
    <Dialog modal open={open} onOpenChange={setOpen}>
      <DialogTrigger className={buttonVariants()}>View The Collection</DialogTrigger>

      <DialogContent className="max-w-screen-lg" onOpenAutoFocus={(e) => e.preventDefault()}>
        <DialogHeader>
